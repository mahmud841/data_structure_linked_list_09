...
void insert_at_head_function(Node *&head, Node *&tail, int val)
{
    Node *newNode = new Node(val);
    if (head == NULL)
    {
...
void insert_at_tail_function(Node *&head, Node *&tail, int val)
{
    Node *newNode = new Node(val);
    if (tail == NULL)
    {
...
int main()
{
    ...
    int position, val;
    cin >> position >> val;
    // insert_at_tail_function(head, tail, val);
    ...
    {
        insert_at_head_function(head, tail, val);
    }
    else if (position == size(head))
    {
        insert_at_tail_function(tail, tail, val);
    }
    // else if (position >= size(head))
    // {
    //     cout << "Invalid" << endl;
